		...
		return (
			<div id="shortcut">
				<ul>
					...
					<li>
						<Link to="/profile" className="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span className="iconbox"> <i className="fa fa-user fa-4x" /> <span>个人信息 </span> </span> </Link>
					</li>
				</ul>
			</div>
		)
